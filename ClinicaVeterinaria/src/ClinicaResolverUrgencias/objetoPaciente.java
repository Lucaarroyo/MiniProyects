...
public class objetoPaciente {
	...
	public objetoPaciente(String nombre, String apellido1, String apellido2, String tipo, String pet, String seguro,
			boolean vacunas, boolean castrado) {
		super();
		this.nombre = nombre;
	...
	public objetoPaciente() {
		...
		// Nos creamos un random para aplicar funcion gausiana al array de animalitos
