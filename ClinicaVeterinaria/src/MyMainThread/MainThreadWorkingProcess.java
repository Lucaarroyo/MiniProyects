...
public class MainThreadWorkingProcess {
	...
	public static void main(String[] args) {
		...
		/* Hemos creado nuestro propio repositorio de métodos de lectoescritura para uarlos cuando sea menester
		 * Instanciamos la copia
		 * Una vez generado el documento, vamos a crear dos copias del documento, de
		 * modo que operaremos con la copia y tendremos el original como backup
		 */
